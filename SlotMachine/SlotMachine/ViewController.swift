...
//  SlotMachine
//
//  Created by Diaz Orona, Jesus A. on 4/10/15.
...
class ViewController: UIViewController {
    ...
    func setupFirstContainer(containetView:UIView){
        ...
        self.titleLabel.center = containetView.center
        containetView.addSubview(self.titleLabel)
    ...
    func removeSlotImageViews(){
        if self.secondContainer != nil{
            ...
            let subViewsArray:Array? = container?.subviews
